...
$_POST = json_decode(file_get_contents("php://input"), true);
    ...
    $cs = $con -> query("SELECT * FROM vEmpleados2021 WHERE claveUno = '30427' AND (correoUno NOT LIKE '')");
        ...
        if(file_exists($archivoQr)){
            ...
            if(file_exists($archivoPdf)){
                ...
                $mail = new PHPMailer(true);
                    ...
                    $mail->addAddress('hackuna885@gmail.com');     //Correo de Salida - Recuerda cambiar abajo en Correo:
